...
const Notification = () => {
  ...
  return (
    <div className="relative grid ml-auto sm:mr-4 md:mr-6 place-items-center">
      <button
      ...
      >
        <IconBell className="w-5 h-5 fill-violet-600 md:w-6 md:h-6 dark:fill-violet-800" />
      </button>
      {notificationIsVisible && (
        <div className="absolute right-0 p-3 border rounded-md bg-slate-100 dark:bg-slate-800 top-full w-52 border-slate-300 dark:border-slate-700">
