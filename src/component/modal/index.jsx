...
const ModalContent = ({ children, onClose, title }) => {
  ...
  return (
    ...
    >
      <section className="relative flex flex-col justify-start w-full max-w-lg p-3 rounded-lg bg-slate-200 sm:p-5 dark:bg-slate-900">
        <button
        ...
        <h2 className="mb-5 text-lg font-medium md:text-2xl">{title}</h2>
        {children}
      </section>
    </div>
  );
